# original git commit hash 59c392b44eb2920240b05a46e7f9c069ef374558
...
function(_ICU_FIND)
  ...
  foreach(component ${ICUCobbletext_FIND_COMPONENTS})  # custom
    ...
    list(APPEND component_libnames "icu${component}cobbletext")  # custom
    list(APPEND component_debug_libnames "icu${component}cobbletextd") # custom
    if(component STREQUAL "data")
      list(APPEND component_libnames "icudtcobbletext") # custom
      # Note there is no debug variant at present
      list(APPEND component_debug_libnames "icudtcobbletextd") # custom
    endif()
    if(component STREQUAL "dt")
      list(APPEND component_libnames "icucobbletextdata") # custom
      # Note there is no debug variant at present
      list(APPEND component_debug_libnames "icudatacobbletextd") # custom
    endif()
    if(component STREQUAL "i18n")
      list(APPEND component_libnames "icuincobbletext") # custom
      list(APPEND component_debug_libnames "icuincobbletextd") # custom
    endif()
    if(component STREQUAL "in")
      list(APPEND component_libnames "icui18ncobbletext") # custom
      list(APPEND component_debug_libnames "icui18ncobbletextd") # custom
    endif()
    ...
    include(SelectLibraryConfigurations) # custom
...
include(FindPackageHandleStandardArgs) # custom
...
if(ICU_FOUND)
  ...
  foreach(_ICU_component ${ICUCobbletext_FIND_COMPONENTS})  # custom
...
if(ICU_DEBUG)
  ...
  foreach(component IN LISTS ICUCobbletext_FIND_COMPONENTS) # custom
    string(TOUPPER "${component}" component_upcase)
