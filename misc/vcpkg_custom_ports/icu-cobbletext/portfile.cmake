...
vcpkg_download_distfile(
    ...
    FILENAME "icu4c-${VERSION2}-data.tgz"
    SHA512 e8db6163c1b49bf0fa4713076df4d754a56d7fa417e6c83660253344baf3217f56a8224f0bf700063e58b7617e13132cc109ec41fb18948c7e591e468808dcde
)
# custom end /\
...
# custom begin \/
vcpkg_extract_source_archive_ex(
    OUT_SOURCE_PATH DATA_PATH
    ARCHIVE ${DATA_ARCHIVE}
    NO_REMOVE_ONE_LEVEL
)
if(NOT (EXISTS ${SOURCE_PATH}/source/data.original))
    file(RENAME ${SOURCE_PATH}/source/data ${SOURCE_PATH}/source/data.original)
    file(COPY ${DATA_PATH}/data DESTINATION ${SOURCE_PATH}/source/)
endif()
# custom end /\
...
# custom begin \/
set(CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS} --with-library-suffix=cobbletext")
set(ENV{ICU_DATA_FILTER_FILE} "${CMAKE_CURRENT_LIST_DIR}/../../icu/icu_data_filter.json")
# custom end /\
